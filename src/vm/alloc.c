...
// Define all the use cases, since we need all
#define USE_CASE1
#define USE_CASE2
#define USE_CASE3
#define USE_CASE4
...
liballoc_free(void* ptr, size_t pages)
{
  vm_phys_free((void*)((uintptr_t)ptr - VM_MEM_OFFSET), pages);
...
void*
PREFIX(calloc)(size_t nobj, size_t size)
{
  int real_size;
  void* p;
...
void*
PREFIX(realloc)(void* p, size_t size)
{
  void* ptr;
  struct liballoc_minor* min;
