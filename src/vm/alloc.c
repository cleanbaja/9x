...
static uintptr_t heap_base = 0xFFFFE00000000000;
...
void* liballoc_alloc(int pages) {
    uintptr_t alloc_addr = ((uintptr_t)vm_phys_alloc(pages)) + heap_base;
    vm_virt_map(&kernel_space, alloc_addr - heap_base, alloc_addr, VM_PERM_READ | VM_PERM_WRITE);
