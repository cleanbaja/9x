...
#define CPUID_ECX_DEADLINE (1U << 24U)
...
/* CPUID.07H:EBX.AVX512_FOUNDATION */
#define CPUID_EBX_AVX512 (1U << 16U)
/* CPUID.01H:ECX.PCID*/
#define CPUID_ECX_PCID (1U << 17U)
/* CPUID.0DH.EAX.XSAVEC */
#define CPUID_EAX_XSAVEC (1U << 1U)
